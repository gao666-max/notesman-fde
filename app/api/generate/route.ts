...
2. **标题**：必须有反常识张力，让人停下来读。

好的标题 = 一个具体的判断 + 一个反常识的转折。
- ✅ "AI不会淘汰人，但会淘汰没有能动性的人"
- ✅ "AI不会淘汰你，但会淘汰那个只想被夸的人"
- ❌ "AI时代的能动性革命：从恐惧到驾驭的生存法则"（模板腔，"从X到Y"是AI味）
- ❌ "拥抱AI：新时代的生存之道"（正确的废话）
- ❌ "AI时代的XX能力"（任何以"AI时代"开头的标题都太泛）

**反复检查**：如果你的标题里出现"从……到……""新时代""革命""驾驭""法则""之道""拥抱"这些词，全部重写。用嘉宾原话里的金句，不自己发明。
